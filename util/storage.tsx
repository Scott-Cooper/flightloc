...
const saveSettings = async () => {
  ...
  storeDataValue ('settings_gpsUpdateTime',  JSON.stringify(state.settings.gpsUpdateTime))
...
const getSettings = async () => {
  ...
  state.settings.gpsUpdateTime = eval((await AsyncStorage.getItem('settings_gpsUpdateTime')) || '3.0')
  ...
  state.settings.speechRate = eval((await AsyncStorage.getItem('settings_speechRate')) || '1.3')
